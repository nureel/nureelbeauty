...
<nav class="relative bg-neutral-900">
					...
					<div class="ml-10 flex space-x-4">
						...
						{#if $session.user.type !== 0}
							<a href="/dashboard/list" class="group text-amber-400 hover:bg-neutral-700 hover:text-pink-400 active:bg-neutral-800 active:text-pink-400 px-3 py-2 rounded-md font-medium">
								<i class="hidden xl:inline-block align-middle">
									<svg width="20" height="20" class="fill-amber-400 group-hover:fill-pink-400" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><path d="M0 96C0 60.65 28.65 32 64 32H448C483.3 32 512 60.65 512 96V416C512 451.3 483.3 480 448 480H64C28.65 480 0 451.3 0 416V96zM64 160H128V96H64V160zM448 96H192V160H448V96zM64 288H128V224H64V288zM448 224H192V288H448V224zM64 416H128V352H64V416zM448 352H192V416H448V352z"/></svg>							
								</i>
								<span class="align-middle ml-1">Senarai</span>
							</a> 

							<a href="/dashboard/product" class="group text-amber-400 hover:bg-neutral-700 hover:text-pink-400 active:bg-neutral-800 active:text-pink-400 px-3 py-2 rounded-md font-medium">
								<i class="hidden xl:inline-block align-middle">
									<svg width="20" height="20" class="fill-amber-400 group-hover:fill-pink-400" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512"><path d="M75.23 33.4L320 63.1L564.8 33.4C571.5 32.56 578 36.06 581.1 42.12L622.8 125.5C631.7 143.4 622.2 165.1 602.9 170.6L439.6 217.3C425.7 221.2 410.8 215.4 403.4 202.1L320 63.1L236.6 202.1C229.2 215.4 214.3 221.2 200.4 217.3L37.07 170.6C17.81 165.1 8.283 143.4 17.24 125.5L58.94 42.12C61.97 36.06 68.5 32.56 75.23 33.4H75.23zM321.1 128L375.9 219.4C390.8 244.2 420.5 255.1 448.4 248L576 211.6V378.5C576 400.5 561 419.7 539.6 425.1L335.5 476.1C325.3 478.7 314.7 478.7 304.5 476.1L100.4 425.1C78.99 419.7 64 400.5 64 378.5V211.6L191.6 248C219.5 255.1 249.2 244.2 264.1 219.4L318.9 128H321.1z"/></svg>								
								</i>	
									<span class="align-middle ml-1">Produk</span>
							</a>   
							...
							<a href="/dashboard/feedback" class="group text-amber-400 hover:bg-neutral-700 hover:text-pink-400 active:bg-neutral-800 active:text-pink-400 px-3 py-2 rounded-md font-medium">
								<i class="hidden xl:inline-block align-middle">
									<svg width="20" height="20" class="fill-amber-400 group-hover:fill-pink-400" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><path d="M511.1 63.1v287.1c0 35.25-28.75 63.1-64 63.1h-144l-124.9 93.68c-7.875 5.75-19.12 .0497-19.12-9.7v-83.98h-96c-35.25 0-64-28.75-64-63.1V63.1c0-35.25 28.75-63.1 64-63.1h384C483.2 0 511.1 28.75 511.1 63.1z"/></svg>
								</i>
	...
	<div class="{mobile === false ? 'hidden' : 'visible'}" id="mobile-menu">
		<div class="z-10 px-2 pt-2 pb-3 space-y-1 sm:px-3">
			...
			<a href="/dashboard/order" class="text-amber-400 hover:bg-neutral-700 hover:text-pink-400 block px-3 py-2 rounded-md text-base font-medium">Stok</a>
			...
			{/if}
			{#if $session.user.type === 1}
				<a href="/dashboard/setting" class="text-amber-400 hover:bg-neutral-700 hover:text-pink-400 block px-3 py-2 rounded-md text-base font-medium">Tetapan</a>
			{/if}
		</div>
